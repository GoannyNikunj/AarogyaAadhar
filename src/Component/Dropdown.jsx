...
//       // Set width and max options for specific labels
//       if (label === 'Registration' || label === 'Login' || label === 'Language') {
//         setDropdownWidth(140);
//         return;
...
//       setDropdownWidth(Math.max(calculatedWidth, columnWidth));
//     };
...
//       <button
//         className={`inline-flex justify-center w-full h-8 text-[#4b3279] rounded-md px-1 sm:px-2 py-1 text-[12px] lg:px-0 xl:px-[6px] sm:text-sm lg:text-[11px] xl:text-sm font-medium`}
...
//                   minWidth: `${label === 'Register' || label === 'Login' || label === 'Language' ? 140 : 220}px`, 
