...
const Navbar = () => {
  ...
  const dropdownData = [
    ...
    },
    {
      ...
      options: [
       "Medical Personanel Manning","Companies Insurance","CSR Services","Health Talks & Seminars","Occupational Health Center","Corporate Health Check-Ups","24/7 Ambulance Service","Equipped Mobile Medicle Unit"
      ],
    },
